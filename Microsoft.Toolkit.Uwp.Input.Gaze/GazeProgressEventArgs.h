...
public:
	...
	property TimeSpan Elapsed { TimeSpan get() { return *ref new TimeSpan { 10 * ElapsedTicks }; } }
	property int64 TriggerTicks;
	property TimeSpan Trigger { TimeSpan get() { return *ref new TimeSpan { 10 * TriggerTicks }; } }
